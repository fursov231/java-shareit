...
class ItemRequestServiceImplTest {
    ...
    @BeforeEach
    public void init() {
        user = userService.createUser(UserRequestDto.builder().name("Ivan").email("ivan@mail.com").build());
        user2 = userService.createUser(UserRequestDto.builder().name("Boris").email("boris@mail.com").build());
